                ...
                <div class="d-flex justify-content-center position-relative">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Job Channel</li>
                        </ol>
                    </nav>
                </div>
            </div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-purple bg-opacity-10 text-purple">Internship</a>
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>12 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Full-Time</a>
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>14 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>3 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>6 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>10 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>23 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-info bg-opacity-10 text-info">Project</a>
									<a href="#" class="h6 fw-light mb-0"><i class="far fa-heart"></i></a>
								</div>
								<!-- Title -->
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>22 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>16 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>13 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>44 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between mt-2">
									<span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>6h 56m</span>
									<span class="h6 fw-light mb-0"><i class="fas fa-user text-orange me-2"></i>50 Pelamar</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row justify-content-center position-relative">
				...
				<div class="col-12 position-relative my-2 my-sm-3">
					<div class="row align-items-center">
						<!-- Title -->
						<div class="col-lg-6">
							<h3 class="text-white mb-3 mb-lg-0">Silahkan subscribe untuk mendapatkan informasi lowongan pekerjaan terkini</h3>
						</div>
						<!-- Input item -->
