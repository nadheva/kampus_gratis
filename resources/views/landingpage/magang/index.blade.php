            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-10 text-center mx-auto position-relative">
                        ...
                        <!-- Title -->
                        <h1 class="position-relative fs-2">Program Magang Kampus Gratis</h1>
                    </div>
                    <!-- Title and SVG END -->
                </div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="row g-4">
                            ...
                            <div class="col-10 col-lg-10">
                                <img class="rounded-4" src="{{ asset('assets/images/teams/aset4.png') }}" alt="">
                            </div>
                            <!-- Image -->
                            <div class="col-12">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-md-12">
                                <div class="bg-grad rounded-4 p-5 text-start">
                                    <h3 class="text-white">“The only source of knowledge is experience”</h3>
                                    <span class="text-white">~ Albert Einstein</span>
                                </div>
                            </div>
                            <!-- Image -->
                            <div class="col-sm-6 col-md-12 col-lg-6">
                                <img class="rounded-4" src="{{ asset('assets/images/teams/aset3.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    About founder START -->
        <section class="pt-0 pt-md-5">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-lg-8">
                        <h2>PT Menara Indonesia</h2>
                        <p class="mb-0" align="justify">
                            PT Menara Indonesia adalah sebuah Lembaga Consultant Management yang mempunyai pengalaman
                            lebih dari 18 tahun mengabdi bagi dunia bisnis dan edukasi professional di Indonesia. Menara
                            Indonesia didirikan oleh salah satu pendiri <strong> Wikimedia Indonesia</strong>, menjabat
                            sebagai ketua dewan penasihat Wikimedia Indonesia awal berdirinya.

                            Salah satu mimpi pendiri perusahaan adalah memberikan solusi pendidikan tinggi yang Gratis,
                            Berkualitas, Bisa Diakses siapapun khususnya kalangan marjinal, dan selalu update, layaknya
                            platform Wikipedia.
                            Di tahun 2022, PT Menara Indonesia mewujudkannya melalui produk aplikasi bernama
                            <strong>KAMPUS GRATIS</strong>, yang menggunakan sistem belajar berbasis Online.

                            Program KAMPUS GRATIS LEARNING MANAGEMENT SYSTEM II ini, merupakan program lanjutan, yang
                            akan mengerjakan <strong> 32 Fitur Kampus Gratis Platform</strong>.

                            <br> <br>
                            Melalui sistem pembelajaran berbasis online, mahasiswa akan mendapatkan kesempatan
                            Pendidikan, pelatihan dan kemampuan baru secara digital dan gratis.

                            Dasar dari <strong>KAMPUS GRATIS</strong> adalah system management e-learning, yang
                            mencantumkan laporan peningkatan atau progress pembelajaran siswa, layaknya seperti kampus
                            perguruan tinggi. Guna pelaksanaan program tersebut, kami merekrut mahasiswa untuk di
                            ikutkan kedalam pembelajaran kegiatan magang dan dibimbing oleh para mentor yang
                            profesional. Dengan mengikuti program ini, mahasiswa akan memperoleh <strong>hands on
                                experience</strong> yang praktis, serta di akhir periode di arahkan guna memperoleh
                    ...
                    <div class="col-lg-7 mt-4 mt-lg-0">
                        ...
                        <ul class="list-group list-group-borderless mt-4">
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>Seleksi administrative:
                                Memeriksa kelengkapan dan kesesuaian berkas kandidat pemagang.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>Wawancara oleh Competence Expert
                                yang ahli dibidangnya, untuk mengetahui tingkat kemampuan teknis dan pengalaman.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>MOU antara Kampus Gratis dan
                                Universitas.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>Kontrak dengan mahasiswa dan
                        ...
                        <ul class="list-group list-group-borderless mt-4">
                            <li class="list-group-item d-flex">
                                <i class="bi bi-cursor-fill text-info me-2"></i>Periode awal, dimulai Pertengahan
                                Februari, Maret, April, hingga pertengahan mei 2022
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-cursor-fill text-info me-2"></i>Periode akhir, dimulai pertengan Mei,
                                Juni, Juli, hingga pertengahan Agustus 2022.
                            </li>
                        </ul>
                        ...
                        <ul class="list-group list-group-borderless mt-4">
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Di lakukan 4 jam per hari di tambah 30
                                menit meeting koordinasi harian, senin sampai jumat, selama 15 minggu (3 bulan).
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Mahasiswa dapat mengikuti magang sambil
                                kuliah, dan dapat memilih untuk mengikuti magang di pagi hari atau sore hari, sesuai
                                kesediaan waktunya.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Mahasiswa tetap diminta untuk membuat
                                laporan harian sesuai format yang sudah di tetapkan, untuk kemudian menjadi bahan untuk
                                penilaian bulanan dan penilaian akhir.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Mahasiswa boleh mengikuti program
                                magang sambil pada saat yang sama mengikuti kuliah dikampusnya.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Bila mahasiswa sedang mengikuti ujian,
                                penugasan kampus, atau keadaan emergensi, maka diperbolehkan menukar hari atau izin.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Bila diperlukan, Peraturan magang dapat
                                disesuaikan untuk setiap kampus, mengacu kepentingan kampus yang bersangkutan.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Penilaian mahasiswa mengikuti aturan
                                dari kampus yang bersangkutan.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Terdapat dua program, pagi dan sore,
                                dan mahasiswa mengikuti hanya setengah hari, fleksibel bisa di ubah-ubah sesuai dengan
                                kepentingannya di bulan itu.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Mahasiswa direkomendasikan untuk
                                membuat skripsi terkait pekerjaan magang di tempat kami.
                            </li>
                            <li class="list-group-item d-flex">
                                <i class="bi bi-disc-fill text-success me-2"></i>Untuk setiap mahasiswa magang akan
                                ditugaskan mentor yg berpengalaman, khususnya sebagai konsultan dengan pengalaman lebih
                                dari 7 tahun
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-10 text-center mx-auto position-relative mt-4">
                    <!-- Image -->
                    <img src="{{ asset('assets/images/teams/magang.png') }}" class="rounded" alt="magang"
                        width="70%">
                </div>
                <div class="col-7 text-center mx-auto position-relative mt-4">
                    ...
                    <div class="d-grid gap-2">
                        <a href="https://forms.gle/id6v3eTRe8CfCJLf7" class="btn btn-warning btn-lg mt-2"
                            target="_BLANK" style="font-size: 25px; font-weight:bold;">DAFTAR MAGANG</a>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4 mb-md-0">
                        ...
                        <ul class="list-group list-group-borderless mt-4">
                            ...
                            <li class="list-group-item d-flex align-items-center px-0">
                                <h6 class="mb-0">6</h6>
                                <span class="fs-6 ms-3">Learner Progress, Asessment Center & Competency
                                    Development</span>
                            </li>
                            <!-- Posisi Magang item -->
                            <li class="list-group-item d-flex align-items-center px-0">
                        ...
                        <div class="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover mt-2 mt-sm-5">
                            <div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false"
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="avatar avatar-xxl mb-3">
                                        <img class="avatar-img rounded-circle"
                                            src="{{ asset('assets/images/teams/tifa.png') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="avatar avatar-xxl mb-3">
                                        <img class="avatar-img rounded-circle"
                                            src="{{ asset('assets/images/teams/dewi.png') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <h6 class="mb-0"><a href="#">Dewi</a></h6>
                                    <p class="mb-0 small">Lecturer Management</p>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="avatar avatar-xxl mb-3">
                                        <img class="avatar-img rounded-circle"
                                            src="{{ asset('assets/images/teams/riyanti.png') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <h6 class="mb-0"><a href="#">Riyanti</a></h6>
                                    <p class="mb-0 small">App & Web Developer</p>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="avatar avatar-xxl mb-3">
                                        <img class="avatar-img rounded-circle"
                                            src="{{ asset('assets/images/teams/delvina.png') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <h6 class="mb-0"><a href="#">Delvina</a></h6>
                                    <p class="mb-0 small">Digital Marketing</p>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="avatar avatar-xxl mb-3">
                                        <img class="avatar-img rounded-circle"
                                            src="{{ asset('assets/images/teams/bunga.png') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <h6 class="mb-0"><a href="#">Bunga</a></h6>
                                    <p class="mb-0 small">Lecturer Management</p>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="avatar avatar-xxl mb-3">
                                        <img class="avatar-img rounded-circle"
                                            src="{{ asset('assets/images/teams/yurike.png') }}" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <h6 class="mb-0"><a href="#">Yurike</a></h6>
                                    <p class="mb-0 small">Digital Marketing</p>
                                </div>
                            </div>
                        </div>
