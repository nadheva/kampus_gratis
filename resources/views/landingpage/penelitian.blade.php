        ...
        <div class="container">
            <div class="row">
                            ...
                            <div>
                                <div
                                    ...
                                    <h5 class="mb-1"><a href="#"
                                            class="stretched-link">{{ $item->judul }}</a></h5>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
                    <h3>Temukan Riset Kolaboratif</h3>
                    <!-- Tab contents START -->
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="course-pills-1" role="tabpanel"
                            ...
                            <p>As it so contrasted oh estimating instrument. Size like body someone had. Are conduct
                                ...
                                offending her ask own. Praise effect wishes change way and any wanted. Lively use looked
                                latter regard had. Do he it part more last in. Merits ye if Mr narrow points. Melancholy
                                particular Devonshire alteration it favorable appearance up.</p>
                            <p>Size like body someone had. Are conduct viewing boy minutes warrant the expense?
                                ...
                                change way and any wanted. Lively use looked latter regard had. Do he it part more last
                                in. Merits ye if Mr narrow points. Melancholy particular Devonshire alteration it
                                favorable appearance up.</p>
                            <p>Are conduct viewing boy minutes warrant the expense? Tolerably behavior may admit
                                daughters offending her ask own. Praise effect wishes change way and any wanted. Lively
                                use looked latter regard had. Do he it part more last in. Merits ye if Mr narrow points.
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="mb-0">Jurnal Pilihan</h2>
                </div>
            </div>
                                ...
                                <div class="card border mb-1">
                                    <div class="card-body">
                                        ...
                                        <div class="row item-collapse">
                                            <!-- Button -->
                                            <div class="mt-3"><a href="#" class="btn btn-primary-soft">Lihat
                                                    Jurnal</a></div>
                                        </div>
                                    </div>
                                </div>
