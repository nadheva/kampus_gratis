...
<section class="position-relative pt-5">
	...
	<figure class="position-absolute top-0 end-0">
		<svg width="822.2px" height="301.9px" viewBox="0 0 822.2 301.9">
			<path class="fill-success opacity-5" d="M752.5,51.9c-4.5,3.9-8.9,7.8-13.4,11.8c-51.5,45.3-104.8,92.2-171.7,101.4c-39.9,5.5-80.2-3.4-119.2-12.1 c-32.3-7.2-65.6-14.6-98.9-13.9c-66.5,1.3-128.9,35.2-175.7,64.6c-11.9,7.5-23.9,15.3-35.5,22.8c-40.5,26.4-82.5,53.8-128.4,70.7 c-2.1,0.8-4.2,1.5-6.2,2.2L0,301.9c3.3-1.1,6.7-2.3,10.2-3.5c46.1-17,88.1-44.4,128.7-70.9c11.6-7.6,23.6-15.4,35.4-22.8 c46.7-29.3,108.9-63.1,175.1-64.4c33.1-0.6,66.4,6.8,98.6,13.9c39.1,8.7,79.6,17.7,119.7,12.1C634.8,157,688.3,110,740,64.6 c4.5-3.9,9-7.9,13.4-11.8C773.8,35,797,16.4,822.2,1l-0.7-1C796.2,15.4,773,34,752.5,51.9z"/>
		</svg>
	</figure>
			...
			<div class="col-lg-6 position-relative mt-5 mt-lg-0">
				...
				<div class="position-absolute bottom-0 start-0 mb-0 mb-sm-4 ms-3 ms-sm-5 z-index-9">
					<div class="d-flex align-items-center p-2 p-sm-3 bg-white shadow rounded-4">
						...
						<div class="ms-2">
							<h6 class="mb-0 text-dark">Kampus Gratis</h6>
							<span class="small">Year 2021</span>
						</div>
					</div>
				</div>

				<!-- Image -->
				<img src="assets/images/about/07.jpg" class="rounded-3 z-index-1 position-relative" alt="Tutor image">
			</div>
			<!-- Right content END -->
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 text-center mx-auto">
				<h2 class="fs-1">Program Studi</h2>
	...
	<div class="container position-relative">
		<div class="row justify-content-between align-items-center my-5">
			...
			<div class="col-lg-5 position-relative">
				...
				<!-- Title -->
				<h2 class="h1">Panduan penggunakan aplikasi Kampus Gratis</h2>
				<button type="button" class="btn btn-outline-info btn-lg">Download</button>
			</div>
			...
			<div class="col-lg-5 position-relative mt-4 mt-lg-0">
				...
				{{-- <video src="https://www.youtube.com/watch?v=vtnFgiiSdaE&ab_channel=Minecraft" class="border border-5 border-white rounded-2"></video> --}}
				<div class="position-absolute top-50 start-50 translate-middle">
					<!-- Video link -->
					<a href="https://www.youtube.com/watch?v=vtnFgiiSdaE&ab_channel=Minecraft" class="btn text-danger btn-round btn-white-shadow btn-lg mb-0" data-glightbox data-gallery="video-tour">
