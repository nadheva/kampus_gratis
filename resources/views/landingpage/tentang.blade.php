                    ...
                    <div class="d-flex justify-content-center position-relative">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tentang Kampus Gratis</li>
                            </ol>
                        </nav>
                    </div>
                </div>
              ...
              <div class="col-lg-4">
                    ...
                    <div class="col-md-6 col-lg-12">
                        ...
                        <div class="card card-body shadow p-4 mb-4">
                            <!-- Title -->
                            <h4 class="mb-3">Tentang Kampus Gratis</h4>
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="h6 fw-light mb-0"><a href="#">Struktur Organisasi</a></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="h6 fw-light mb-0"><a href="#">Latar Belakang Kampus Gratis</a></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="h6 fw-light mb-0"><a href="#">Identitas Kampus Gratis</a></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="h6 fw-light mb-0"><a href="#">Visi dan Misi Kampus Gratis</a></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="h6 fw-light mb-0"><a href="#">Prestasi</a></span>
                                </li>
                            </ul>
                        </div>
                        <!-- Course info END -->
                    ...
                    <div class="bg-body shadow rounded-2 p-4">
                        <div class="tab-content pt-2" id="course-pills-tabContent">
                                ...
                                <p class="mb-3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dasar dari KAMPUS GRATIS adalah system management e-learning yang mencantumkan laporan peningkatan atau progress pembelajaran siswa layaknya seperti kampus perguruan tinggi.
                                    Program KAMPUS GRATIS LEARNING MANAGEMENT SYSTEM II ini, merupakan program lanjutan, yang akan mengerjakan 32 Fitur Kampus Gratis Platform.</p>
                                <div class="col-12">
                                </div>
                            </div>
                         </div>
                ...
                <section class="py-0 py-lg-5">
                    ...
                    <div class="text-center mt-5">
                        <a href="#" class="btn btn-primary-soft mb-0">Baca Selengkapnya</a>
                    </div>
                </section>
                <section class="py-0">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="bg-dark p-1 text-center rounded-1">
                                    <h3 class="text-white m-1">Guru Besar</h3>
                                </div>
                            </div>
                        </div>
                    </div>
