                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 order-1">
                            <!-- Pre title -->
                            <span>{{ $berita->penulis }}</span><span
                                class="mx-2">|</span><span>{{ $berita->created_at->diffForHumans() }}</span><span
                                class="mx-2">|</span>
                            <a href="{{ route('kategori_berita', $berita->category->slug) }}">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-12 mt-4 mt-lg-0">
                            <p><span class="dropcap h6 mb-0 px-2">{{ $firstLetter }}</span> {!! $berita->isi !!}
                            </p>
                        </div>
                    </div>
