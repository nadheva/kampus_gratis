			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="card card-body shadow rounded-3">
					<div class="d-flex align-items-center">
						...
						<div class="ms-3">
							<h5 class="mb-0"><a href="#" class="stretched-link">Sales</a></h5>
							<span>89 Alumni</span>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="card card-body shadow rounded-3">
					<div class="d-flex align-items-center">
						...
						<div class="ms-3">
							<h5 class="mb-0"><a href="#" class="stretched-link">Credit</a></h5>
							<span>95 Alumni</span>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-6 col-lg-4 col-xl-3">
				<div class="card card-body shadow rounded-3">
					<div class="d-flex align-items-center">
						...
						<div class="ms-3">
							<h5 class="mb-0"><a href="#" class="stretched-link">Collection</a></h5>
							<span>38 Alumni</span>
						</div>
					</div>
				</div>
				...
				<h3>{{$a->nama}}</h3>
					<ul class="nav nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
						...
						<li class="nav-item me-2 me-lg-4" role="presentation">
							<button class="nav-link mb-2 mb-xl-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Deskripsi</button>
						</li>
						<!-- Tab item -->
						<li class="nav-item me-2 me-lg-4" role="presentation">
							<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false">Kegiatan Alumni</button>
						</li>
					</ul>
...
<section class="bg-blue align-items-center d-flex" style="background:url(assets/images/pattern/04.png) no-repeat center center; background-size:cover;">
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<!-- Title -->
				<h1 class="text-white">Program Project</h1>
			</div>
		</div>
	</div>
</section>
...
<section class="bg-blue align-items-center d-flex" style="background:url(assets/images/pattern/04.png) no-repeat center center; background-size:cover;">
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<!-- Title -->
				<h1 class="text-white">Program Kursus</h1>
			</div>
		</div>
	</div>
</section>
