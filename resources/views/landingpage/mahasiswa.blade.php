...
<section>
	<div class="container">
		...
		<div class="tab-content" id="course-pills-tabContent">
				...
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="{{asset($p->gambar)}}" class="card-img-top" alt="course image">
							<!-- Card body -->
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">{{$p->jenis}}</a>
								</div>
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="#">{{$p->judul}}</a></h5>
								<p class="mb-2 text-truncate-2">{{$p->isi}}</p>
							</div>
							<!-- Card footer -->
							<div class="card-footer pt-0 pb-3">
								<hr>
								<div class="d-flex justify-content-between">
									<span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>{{$p->created_at->diffForHumans()}}</span>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- Content START -->
			@foreach($prestasi as $p)
			<div class="tab-pane fade" id="course-pills-tabs-{{$p->tahun}}" role="tabpanel" aria-labelledby="course-pills-tab-{{$p->tahun}}">
				<div class="row g-4">
					<!-- Card item START -->
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							...
							<div class="card-body pb-0">
								...
								<!-- Title -->
								<h5 class="card-title fw-normal"><a href="#">{{$p->judul}}</a></h5>
								<p class="text-truncate-2 mb-2">{{$p->isi}}</p>
							</div>
							<!-- Card footer -->
							<div class="card-footer pt-0 pb-3">
								<hr>
