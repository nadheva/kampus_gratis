	...
	<div class="container">
		<div class="row g-md-5 align-items-center">
				...
				<div class="row mt-4 mt-md-0">
					...
					<div class="col-8 col-sm-5 mt-n6 align-items-end position-relative">
						...
						<div class="p-3 bg-body shadow rounded-3 d-inline-block position-relative mt-n2">
							<!-- Info -->
							<h6 class="mb-2">Belajar Gratis <span class="ms-1"><i class="fas fa-check-circle text-success"></i></span></h6>
							<p class="mb-0 small">Learning Management System</p>
							<!-- Icon -->
			...
			<div class="col-lg-6 mt-5 mt-lg-0">
				<!-- Title -->
				<h2 class="mb-3">Learning Management System</h2>
				...
				<!-- Button -->
				<a href="#" class="btn btn-primary-soft mb-0 mt-3 mt-lg-4">More about us</a>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="bg-primary bg-opacity-10 rounded-3 text-center p-3 position-relative btn-transition">
					...
					<!-- Title -->
					<h5 class="mb-1"><a href="#" class="stretched-link">Job Channel</a></h5>
...
<!-- =======================
Agenda Mahasiswa END -->


<!-- =======================
Keunggulan Lulusan KG START -->
	...
	<div class="container">
		<div class="row g-4 g-lg-5 align-items-center">
			...
			<div class="col-lg-6 position-relative order-1 order-lg-2">
				<!-- Title -->
				<h2>Keunggulan Lulusan Kampus Gratis</h2>
				...
				<!-- Button -->
				<a href="#" class="btn btn-primary-soft mb-0">More Keunggulan Lulusan KG us</a>
			</div>
		</div>
	</div>
</section>
<!-- =======================
Keunggulan Lulusan KG END -->


<!-- =======================
Prestasi Mahasiswa START -->
<section>
	<div class="container">
		<!-- Title -->
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="fs-1">Prestasi Mahasiswa</h2>
		...
		<ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
			...
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-2" type="button" role="tab" aria-controls="course-pills-tabs-2"	aria-selected="false">2023</button>
			</li>
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-3" type="button" role="tab" aria-controls="course-pills-tabs-3" aria-selected="false">2024</button>
			</li>
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-4" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-4" type="button" role="tab" aria-controls="course-pills-tabs-4" aria-selected="false">2025</button>
			</li>
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-5" type="button" role="tab" aria-controls="course-pills-tabs-5"	aria-selected="false">2026</button>
			</li>
		</ul>
		<!-- Tabs END -->
