        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <!-- Title -->
                    <h2 class="mb-3">
                        Sammbutan Pimpina Kampus Gratis
                    </h2>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card">
                            <div class="overflow-hidden rounded-3">
                                <img src="{{ $data->gambar }}" class="card-img" alt="course image">
                                <!-- Overlay -->
                                <div class="bg-overlay bg-dark opacity-4"></div>
                                <div class="card-img-overlay d-flex align-items-start p-3">
                                    <!-- badge -->
                                    <a href="#" class="badge bg-danger text-white">{{ $data->kategori }}</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0"><a href="#">{{ $data->penulis }}</a></h6>
