			...
			<div class="col-xl-7 order-2 order-xl-1">
				...
				<div class="row mt-5 mt-xl-0">
					...
					<div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
						...
						<div class="p-3 shadow bg-primary d-inline-block rounded-4 shadow-lg text-center" style="background:url(assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
							<!-- Info -->
