        ...
        <div class="container">
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                    ...
                    <!-- Content -->
                    <p class="my-4 lead">Belajar mudah dengan kampus gratis, tanpa biaya dan dicarikan pekerjaan
                        setelah lulus.</p>

                    <!-- Info -->
                    <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                        <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Pengajar
                            profesional</li>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                        <!-- Button -->
                        <a href="{{ route('register') }}" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Daftar
                            Sekarang!!</a>
                        <!-- Video button -->
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <!-- SVG decoration -->
                    <figure class="position-absolute bottom-0 start-50 translate-middle-x mb-n7 z-index-9">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    ...
                    <p align='justify' style="font-size: 13px">
                        Kampus Gratis, sebagai perguruan tinggi untuk mengemban misi memeratakan pendidikan bagi seluruh
                        warga Negara Indonesia dimanapun mereka berada. Mulai didirikan pada tahun 2021 dan dirancang
                        untuk memfasilitasi mereka yang tidak mempunyai kesempatan menyelesaikan studinya di perguruan
                        tinggi karena berbagai hambatan termasuk faktor ekonomi, geografis dan demografis. Oleh
                        karenanya, Kampus Gratis hadir untuk menjangkau yang tak terjangkau. Website ini adalah salah
                        satu media untuk memperkenalkan dan memberikan informasi secara lengkap mengenai Kampus Gratis,
                        baik untuk mahasiswa maupun masyarakat umum. Kampus Gratis secara konsisten dan konstruktif
                        terus berupaya dan menunjukkan komitmen untuk menjadi yang terbaik dalam memberikan layanan
                        pendidikan melalui sistem pendidikan tinggi terbuka dan jarak jauh (PTTJJ), yang disesuaikan
                        dengan kebutuhan industri dan perkembangan teknologi.
                        <br> <br>
                        Sebagai bentuk kontribusi terhadap pendidikan tinggi nasional, Kampus Gratis terus melakukan
                        terobosan baru yang inovatif untuk menghasilkan lulusan berkualitas tinggi. Disamping itu,
                        sebagai realisasi dari filosofi pendidikan sepanjang hayat (lifelong learning), Kampus Gratis
                        mengembangkan dan memberikan layanan program sertifikat serta berbagai layanan pendidikan gratis
                        melalui berbagai Sumber Pembelajaran Terbuka dan kuliah gratis secara massif, terbuka dan
                        daring/online.
                        <br> <br>
                        Bersama Anda semua, Kampus Gratis hadir untuk mengemban amanah bangsa yang luhur dalam
                        meningkatkan kecerdasan dan martabat bangsa Indonesia tercinta. Mari kita bangun dan jaga negeri
                        ini dengan mewujudkan pagar bangsa yang berkualitas.
                    </p>
        ...
        <div class="container mb-3">
            ...
            <div class="row mb-4">
                <div class="col-sm-10 col-xl-6 text-center mx-auto">
                    ...
                    <p class="mb-0">
                        karena KG adalah kuliah berkualitas, sambil kuliah bisa bekerja, lulus dicarikan kerja,
                        dibimbing oleh para dosen yg ingin berbakti pada bangsa, dosen berkualitas dan disediakan
                        pendanaan bagi yang membutuhkan untuk biaya hidupnya, karena biayanya GRATISSSSSSSS BESTIE
                    </p>
                </div>
            </div>
            ...
            <div class="row g-4 g-md-5">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-truncate-2 mb-0">Satisfied conveying a dependent contented he gentleman agreeable do
                        be. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in
                        do</p>
                </div>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-truncate-2 mb-0">Proceed how any engaged visitor. Explained propriety off out
                        perpetual his you. Feel sold off felt nay rose met you. We so entreaties cultivated astonished
                        is. Was sister for a few longer Mrs sudden talent become. Done may bore quit evil old mile. If
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-truncate-2 mb-0">Insipidity the sufficient discretion imprudence resolution sir him
                        decisively. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly
                        cordial in do</p>
                </div>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-truncate-2 mb-0">
                        Kampus Gratis merupakan edutech pertama yang memberikan akses ke semua kursus secara Gratis di
                        Indonesia. Tidak hanya itu, Kegiatan belajar dan mengajar di Kampus Gratis diadakan secara full
                        online, sehingga mahasiswa dapat belajar kapan saja dan di mana saja.
                    </p>
                </div>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-truncate-2 mb-0">
                        Kampus Gratis bekerjasama dengan universitas-universitas ternama di Indonesia yang memiliki
                        akreditasi A. Sehingga, semua mahasiswa Kampus Gratis dapat merasakan dan mempelajari
                        materi-materi kuliah di universitas ternama dan menambah wawasan mahasiswa. Selain itu, semua
                        lulusan dari Kampus Gratis akan direkomendasikan kepada perusahaan-perusahaan ternama yang sudah
                        bekerjasama dengan Kampus Gratis
                    </p>
                </div>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-truncate-2 mb-0">
                        Materi perkuliahan yang terus berganti dan selalu up to date dengan kurikulum dan trend yang
                        ada, membuat semua mahasiswa Kampus gratis dapat mendapatkan ilmu terkini.
                    </p>
                </div>
            </div> <!-- Row END -->
        </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card">
                            <div class="overflow-hidden rounded-3">
                                <img src="{{ $row->gambar }}" class="card-img" alt="course image">
                                <!-- Overlay -->
                                <div class="bg-overlay bg-dark opacity-4"></div>
                                <div class="card-img-overlay d-flex align-items-start p-3">
                                    <!-- badge -->
                                    <a href="#" class="badge bg-danger text-white">{{ $row->kategori }}</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-truncate-2">{{ $row->isi }}</p>
                                <!-- Info -->
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0"><a href="#">{{ $row->penulis }}</a></h6>
                    ...
                    <div class="bg-secondary rounded-3 bg-opacity-10 p-5 h-100">
                        ...
                        <div class="row">
                            <div class="col-sm-8 position-relative">
                                ...
                                <p class="mb-3 h5 fw-light lead">Enroll now in the most popular and best rated courses.
                                </p>
...
Action box END -->
    ...
    <!-- =======================
Action box START -->
    <section class="py-4 pt-lg-5 mt-4">
        <div class="container">
            <div class="row">
                    ...
                    <div class="bg-grad-pink p-4 p-sm-5 rounded position-relative z-index-n1 overflow-hidden">
                        ...
                        <div class="row g-3 align-items-center justify-content-lg-end position-relative py-4">
                            ...
                            <div class="col-md-6 col-lg-3 text-md-end">
                                <a href="{{ route('register') }}" class="btn btn-white mb-0 btn-lg">Daftar
                                    Sekarang!</a>
                            </div>
                        </div> <!-- Row END -->
                    </div>
                ...
                <div class="col-xl-7 order-2 order-xl-1">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 shadow bg-primary d-inline-block rounded-4 shadow-lg text-center"
