								...
								<tbody>
									...
									<tr>
                                        ...
                                        <td>
											...
											<a href="{{url('guru-besar-destroy',$b->id)}}" class="btn btn-sm btn-danger-soft me-1 mb-1 mb-md-0 show_confirm" data-toggle="tooltip" title='Delete'><i class="bi bi-arrow-repeat me-1"></i>Hapus</a>
										</td>
									</tr>
									@endforeach
								</tbody>
