<div class="list-group list-group-dark list-group-borderless">
    ...
    <a class="list-group-item {{ request()->is('guru-besar*') ? 'active' : '' }}" href="{{ url('guru-besar') }}"><i class="bi bi-cart-check fa-fw me-2"></i>Guru Besar</a>
    <a class="list-group-item {{ request()->is('agenda*') ? 'active' : '' }}" href="{{ url('agenda') }}"><i class="bi bi-cart-check fa-fw me-2"></i>Agenda</a>
