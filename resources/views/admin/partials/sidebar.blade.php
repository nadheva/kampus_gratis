<div class="list-group list-group-dark list-group-borderless">
    ...
    <a class="list-group-item" href="{{route('banner.index')}}"><i class="bi bi-card-checklist fa-fw me-2"></i>Banner (Front Page)</a>
    ...
    <a class="list-group-item" href="{{route('guru-besar.index')}}"><i class="bi bi-basket fa-fw me-2"></i>Guru Besar </a>
    <a class="list-group-item" href="{{route('agenda.index')}}"><i class="bi bi-credit-card-2-front fa-fw me-2"></i>Agenda Kegiatan</a>
    <a class="list-group-item" href="{{route('data-penelitian.index')}}"><i class="bi bi-cart-check fa-fw me-2"></i>Penelitian</a>
    <a class="list-group-item" href="{{route('pengumuman.index')}}"><i class="bi bi-credit-card-2-front fa-fw me-2"></i>Pengumuman</a>
    <a class="list-group-item" href="{{route('pengabdian.index')}}"><i class="bi bi-cart-check fa-fw me-2"></i>Pengabdian</a>
