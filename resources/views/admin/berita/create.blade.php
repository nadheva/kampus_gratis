<x-app-layout>
	...
	<div class="col-xl-9">
	  ...
	  <div class="card border rounded-3">
		  ...
		  <!-- Card body START -->
		  <div class="card-body">
			<form role="form text-left" action="{{route('data-berita.store')}}" method="POST" enctype="multipart/form-data">
			  @csrf
			  <div class="mb-3">
			  ...
			  <div class="text-end">
				...
				<button type="submit" class="btn bg-gradient-dark"><i class="fas fa-plus"></i>&nbsp;&nbsp;Unggah</button>
			  </div>
			</form>
		  </div>
		  <!-- Card body START -->
