	...
	<div class="col-xl-9">
	  ...
	  <div class="card border rounded-3">
		  ...
		  <div class="card-header border-bottom">
			  <h3 class="mb-0">Tambah Data Fitur</h3>
		  </div>
		  <!-- Card header END -->
  
		  <!-- Card body START -->
		  <div class="card-body">
			<form role="form text-left" action="{{route('data-fitur.store')}}" method="POST" enctype="multipart/form-data">
			  @csrf
			  <div class="mb-3">
			  ...
			  <div class="mb-3">
				...
				<input type="text" class="form-control" name="fitur" placeholder="Masukkan Fitur" required>
			  </div>
			  <div class="mb-3">
