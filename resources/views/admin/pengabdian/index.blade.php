    ...
    <div class="col-xl-9">
        ...
        <div class="card border rounded-3">
            ...
            <div class="card-header border-bottom">
                <h3 class="mb-0">Data Pengabdian Kampus Gratis</h3>
            </div>
            <!-- Card header END -->
                        ...
                        <div class="nav-wrapper position-relative end-0">
                          <div class="text-end ms-auto">
                            <div class="mt-2 mt-sm-0">
                                <a href="{{route('pengabdian.create')}}" class="btn btn-outline-primary mb-0">Tambah</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->isi}}</td>
                                <td>
                                    <a href="{{route('pengabdian.edit',$b->id)}}" class="btn btn-sm btn-primary-soft me-1 mb-1 mb-md-0"><i class="bi bi-play-circle me-1"></i>Edit</a>
                                    <form id="form-delete" action="{{route('pengabdian.destroy',$b->id)}}" method="POST"  style="display: inline">
                                        @csrf
                                        @method('DELETE')
